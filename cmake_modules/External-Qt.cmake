...
IF( (NOT Qt5Core_FOUND) OR QT_DOWNLOAD_FORCE )
  ...
  SET( DOWNLOAD_LINK "https://github.com/CBICA/CaPTk/raw/master/binaries/qt_${QT_VERSION}/${PLATFORM_STRING}.zip" )
    ...
    if(CMAKE_SYSTEM_NAME MATCHES "Linux")
      if(EXISTS "/etc/issue")
        ...
        if(LINUX_ISSUE MATCHES "CentOS")
          SET( QT_VERSION "5.11.1" CACHE STRING "Changed Qt version Superbuild Qt version to build CaPTk against" FORCE )
        endif()
      endif()
    endif()
  endif()
