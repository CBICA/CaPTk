...
CaPTk is developed and maintained by the Center for Biomedical Image Computing and Analytics (CBICA - <a href="https://www.cbica.upenn.edu/" target=”_blank”>www.cbica.upenn.edu</a>) at the University of Pennsylvania, and draws upon research from several groups within the Center and beyond. 
...
## Discussion Forum and Requests
Feel free to join our forum and discuss any issue you might come across, as well as to use the "Bug Tracker" and "Feature Requests" links from the "Support Links" available in the "Help" menu of CaPTk.
...
\htmlonly
<div align="right"><a href="GettingStarted.html"><b>Next (Getting Started)<b></a>
\endhtmlonly
