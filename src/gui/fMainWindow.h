 ...
 */
  ...
  */
  ...
  void LoadedSubjectExistingRecurrenceEstimate(const std::string &outputdirectory, bool cbT1Data, bool cbDTIData, bool cbPerfData, bool cbDistData);
  ...
  */
  ...
  void CallPerfusionMeasuresCalculation(const std::string inputImage, const bool rcbv, const bool psr, const bool ph, const std::string outputFolder);
  ...
  */
  ...
  {
    std::string link = "ftp://www.nitrc.org/home/groups/captk/downloads/SampleData/" + action->text().toStdString() + ".zip", command;
#if WIN32
    command = "start ";
#elif __linux__
    command = "xdg-open ";
  ...
  */
  bool CheckCompletenessOfInputData(bool &convDataPresent, bool &perfusionDataPresent, bool &dtiDataPresent);
  ...
  */
  ...
  void PyGUILIBRA_Single();
  void PyGUILIBRA_Batch();
  void PyGUIConfetti();
