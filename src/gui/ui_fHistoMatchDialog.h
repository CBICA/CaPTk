...
public:
  ...
  {
    fHistoMatcher->setWindowTitle(QApplication::translate("fHistoMatcher", "Histogram Matching", 0, QApplication::UnicodeUTF8));
    confirmButton->setText(QApplication::translate("fHistoMatcher", "Confirm", 0, QApplication::UnicodeUTF8));
    cancelButton->setText(QApplication::translate("fHistoMatcher", "Cancel", 0, QApplication::UnicodeUTF8));
