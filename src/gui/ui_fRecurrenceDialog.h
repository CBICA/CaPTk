...
public:
  ...
  void retranslateUi(QDialog *fRecurrenceDialog)
  {
    ...
    rdLoadedClassification->setText(QApplication::translate("fRecurrenceDialog", "Infiltration prediction on loaded subject", 0, QApplication::UnicodeUTF8));
    rdExistingClassification->setText(QApplication::translate("fRecurrenceDialog", "Infiltration prediction on a batch of subjects", 0, QApplication::UnicodeUTF8));
    ...
    modelDirectoryLabel1->setText(QApplication::translate("fRecurrenceDialog", "Model Directory:", 0, QApplication::UnicodeUTF8));
    modelDirectoryLabel2->setText(QApplication::translate("fRecurrenceDialog", "Model Directory:", 0, QApplication::UnicodeUTF8));
    trainingDirectoryLabel->setText(QApplication::translate("fRecurrenceDialog", "Selected Subjects:", 0, QApplication::UnicodeUTF8));
