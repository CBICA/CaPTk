...
public:
  ...
  void retranslateUi(QDialog *fPerfusionEstimator)
  {
    ...
    inputEchoLabel->setText(QApplication::translate("fPerfusionEstimator", "Echo Time", 0, QApplication::UnicodeUTF8));
	inputImageLabel->setText(QApplication::translate("fPerfusionEstimator", "DSC-MRI Image", 0, QApplication::UnicodeUTF8));
    ...
    m_rcbv->setText(QApplication::translate("fPerfusionEstimator", "Automatically-extracted proxy to Relative Cerebral Blood Volume (ap-rCBV)", 0, QApplication::UnicodeUTF8));
    m_psr->setText(QApplication::translate("fPerfusionEstimator", "Percent Signal Recovery (PSR)", 0, QApplication::UnicodeUTF8));
    m_ph->setText(QApplication::translate("fPerfusionEstimator", "Peak Height (PH)", 0, QApplication::UnicodeUTF8));
  } // retranslateUi
};
