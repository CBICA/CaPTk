#ifndef ui_fEGFRvIIIPredictor_H
#define ui_fEGFRvIIIPredictor_H
...
public:
  ...
  void setupUi(QDialog *fEGFRvIIIDialog)
  {

    if (fEGFRvIIIDialog->objectName().isEmpty())
      fEGFRvIIIDialog->setObjectName(QString::fromUtf8("fEGFRvIIIDialog"));
    fEGFRvIIIDialog->setWindowModality(Qt::ApplicationModal);
    fEGFRvIIIDialog->resize(200, 200); // needs to be screenSize dependent
    QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(fEGFRvIIIDialog->sizePolicy().hasHeightForWidth());
    fEGFRvIIIDialog->setSizePolicy(sizePolicy);
    fEGFRvIIIDialog->setMinimumSize(QSize(0, 0));

    //fEGFRvIIIDialog->setModal(true);
    gridLayout_3 = new QGridLayout(fEGFRvIIIDialog);
    gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));

    //--------------------------------------------------------------------
    classificationGroupBox = new QGroupBox(fEGFRvIIIDialog);
    ...
    outputGroupBox = new QGroupBox(fEGFRvIIIDialog);
    ...
    confirmButton = new QPushButton(fEGFRvIIIDialog);
    ...
    cancelButton = new QPushButton(fEGFRvIIIDialog);
    ...
    retranslateUi(fEGFRvIIIDialog);

    QMetaObject::connectSlotsByName(fEGFRvIIIDialog);
  } // setupUi

  void retranslateUi(QDialog *fEGFRvIIIDialog)
  {
    // fEGFRvIIIDialog->setWindowTitle(QApplication::translate("fEGFRvIIIDialog", "Molecular Subtype Predictor", 0, QApplication::UnicodeUTF8));
    // //rdNewClassification->setText(QApplication::translate("fEGFRvIIIDialog", "Subject based", 0, QApplication::UnicodeUTF8));
    // rdExistingClassification->setText(QApplication::translate("fEGFRvIIIDialog", "Use existing model", 0, QApplication::UnicodeUTF8));
    // rdCreateModel->setText(QApplication::translate("fEGFRvIIIDialog", "Train new model", 0, QApplication::UnicodeUTF8));
    // confirmButton->setText(QApplication::translate("fEGFRvIIIDialog", "Confirm", 0, QApplication::UnicodeUTF8));
    // cancelButton->setText(QApplication::translate("fEGFRvIIIDialog", "Cancel", 0, QApplication::UnicodeUTF8));
    //
    // //cbT1Data->setText(QApplication::translate("fEGFRvIIIDialog", "Conventional (T1, T2, Flair, T1Gd)", 0, QApplication::UnicodeUTF8));
    // //cbDTIData->setText(QApplication::translate("fEGFRvIIIDialog", "DTI", 0, QApplication::UnicodeUTF8));
    // //cbPerfData->setText(QApplication::translate("fEGFRvIIIDialog", "Perfusion", 0, QApplication::UnicodeUTF8));
    // //cbDistanceData->setText(QApplication::translate("fEGFRvIIIDialog", "Distance", 0, QApplication::UnicodeUTF8));
    //
    // modelDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Model Directory:", 0, QApplication::UnicodeUTF8));
    // trainingDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Training Directory:", 0, QApplication::UnicodeUTF8));
    // testDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Test Directory:", 0, QApplication::UnicodeUTF8));
    // outputDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Output Directory:", 0, QApplication::UnicodeUTF8));
    // MEW CHANGES
    fEGFRvIIIDialog->setWindowTitle(QApplication::translate("fEGFRvIIIDialog", "EGFRvIII Status Predictor", 0));
    //rdNewClassification->setText(QApplication::translate("fEGFRvIIIDialog", "Subject based", 0));
    rdExistingClassification->setText(QApplication::translate("fEGFRvIIIDialog", "Use existing model", 0));
    rdCreateModel->setText(QApplication::translate("fEGFRvIIIDialog", "Train new model", 0));
    confirmButton->setText(QApplication::translate("fEGFRvIIIDialog", "Confirm", 0));
    cancelButton->setText(QApplication::translate("fEGFRvIIIDialog", "Cancel", 0));

    //cbT1Data->setText(QApplication::translate("fEGFRvIIIDialog", "Conventional (T1, T2, Flair, T1Gd)", 0));
    //cbDTIData->setText(QApplication::translate("fEGFRvIIIDialog", "DTI", 0));
    //cbPerfData->setText(QApplication::translate("fEGFRvIIIDialog", "Perfusion", 0));
    //cbDistanceData->setText(QApplication::translate("fEGFRvIIIDialog", "Distance", 0));

    modelDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Model Directory:", 0));
    trainingDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Selected Subjects:", 0));
    testDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Test Directory:", 0));
    outputDirectoryLabel->setText(QApplication::translate("fEGFRvIIIDialog", "Output Directory:", 0));
  } // retranslateUi

};

namespace Ui {
  class fEGFRvIIIPredictor : public ui_fEGFRvIIIPredictor {};
} // namespace Ui

QT_END_NAMESPACE

#endif // ui_fEGFRvIIIDialog_H