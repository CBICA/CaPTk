...
public:
  ...
  {
    fSkullStripper->setWindowTitle(QApplication::translate("fSkullStripper", "Skull Stripping", 0));
    confirmButton->setText(QApplication::translate("fSkullStripper", "Confirm", 0));
    cancelButton->setText(QApplication::translate("fSkullStripper", "Cancel", 0));
