...
public:
  ...
  void setupUi(QWidget *parent)
  {
    ...
    m_1st_oderstatistics->setChecked(true);
    m_1st_oderstatistics->setEnabled(false);
    ...
    m_Histogramfeature = new    QCheckBox("Histogram-based");
    ...
    m_Co_occurancefeature = new QCheckBox("GLCM (Co-occurrence)");
    m_Co_occurancefeature->setToolTip(QString("Creates a Gray-Level Co-occurrence Matrix (GLCM) for an offset of 1 voxel in 3D."));
    ...
    m_LBPfeature->setCheckState(Qt::CheckState::Unchecked);
