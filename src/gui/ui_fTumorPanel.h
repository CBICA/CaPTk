...
public:
  ...
  void setupUi(QWidget *parent)
  {
    ...
    if (QDir(QApplication::applicationDirPath() + "/../data/icons/").exists()) // packaged binary
    {
      iconDir = QApplication::applicationDirPath().toStdString() + "/../data/icons/";
    }
    else if (QDir(QApplication::applicationDirPath() + "/../../data/icons/").exists()) // developer_mode
    {
      iconDir = QApplication::applicationDirPath().toStdString() + "/../../data/icons/";
    }
  ...
  {
    fTumorPanel->setWindowTitle(QApplication::translate("fTumorPanel", "Form", 0, QApplication::UnicodeUTF8));
    m_typeRadBtnTumor->setText(QApplication::translate("fTumorPanel", "Tumor Points", 0, QApplication::UnicodeUTF8));
    m_typeRadBtnAllTissues->setText(QApplication::translate("fTumorPanel", "All Tissue Points", 0, QApplication::UnicodeUTF8));

    m_typeRadBtnGlister->setText(QApplication::translate("fTumorPanel", "GLISTR/GLISTRboost", 0, QApplication::UnicodeUTF8));
    m_typeRadBtnPorterPre->setText(QApplication::translate("fTumorPanel", "PORTR-PRE", 0, QApplication::UnicodeUTF8));
    m_typeRadBtnPorterPost->setText(QApplication::translate("fTumorPanel", "PORTR-POST", 0, QApplication::UnicodeUTF8));


    auto sHeader = sTableWidget->horizontalHeader();
    sHeader->setResizeMode(QHeaderView::Stretch);
    QTableWidgetItem *___qtablewidgetitem = sTableWidget->horizontalHeaderItem(0);
    ___qtablewidgetitem->setText(QApplication::translate("fTumorPanel", "      x      ", 0, QApplication::UnicodeUTF8));
    QTableWidgetItem *___qtablewidgetitem1 = sTableWidget->horizontalHeaderItem(1);
    ___qtablewidgetitem1->setText(QApplication::translate("fTumorPanel", "      y      ", 0, QApplication::UnicodeUTF8));
    QTableWidgetItem *___qtablewidgetitem2 = sTableWidget->horizontalHeaderItem(2);
    ___qtablewidgetitem2->setText(QApplication::translate("fTumorPanel", "      z      ", 0, QApplication::UnicodeUTF8));
    QTableWidgetItem *___qtablewidgetitem3 = sTableWidget->horizontalHeaderItem(3);
    ___qtablewidgetitem3->setText(QApplication::translate("fTumorPanel", "      r      ", 0, QApplication::UnicodeUTF8));
    ...
    sRemoveButton->setText(QApplication::translate("fTumorPanel", "Remove", 0, QApplication::UnicodeUTF8));
    sRemoveAllButton->setText(QApplication::translate("fTumorPanel", "Clear all", 0, QApplication::UnicodeUTF8));
    sLoadButton->setText(QApplication::translate("fTumorPanel", "Load", 0, QApplication::UnicodeUTF8));
    sSaveButton->setText(QApplication::translate("fTumorPanel", "Save", 0, QApplication::UnicodeUTF8));

    auto tHeader = tTableWidget->horizontalHeader();
    tHeader->setResizeMode(QHeaderView::Stretch);
    QTableWidgetItem *___qtablewidgetitem14 = tTableWidget->horizontalHeaderItem(1);
    ___qtablewidgetitem14->setText(QApplication::translate("fTumorPanel", "      x      ", 0, QApplication::UnicodeUTF8));
    QTableWidgetItem *___qtablewidgetitem15 = tTableWidget->horizontalHeaderItem(2);
    ___qtablewidgetitem15->setText(QApplication::translate("fTumorPanel", "      y      ", 0, QApplication::UnicodeUTF8));
    QTableWidgetItem *___qtablewidgetitem16 = tTableWidget->horizontalHeaderItem(3);
    ___qtablewidgetitem16->setText(QApplication::translate("fTumorPanel", "      z      ", 0, QApplication::UnicodeUTF8));

    tRemoveButton->setText(QApplication::translate("fTumorPanel", "Remove", 0, QApplication::UnicodeUTF8));
    tRemoveAllButton->setText(QApplication::translate("fTumorPanel", "Clear all", 0, QApplication::UnicodeUTF8));
    tLoadButton->setText(QApplication::translate("fTumorPanel", "Load", 0, QApplication::UnicodeUTF8));
    tSaveButton->setText(QApplication::translate("fTumorPanel", "Save", 0, QApplication::UnicodeUTF8));
