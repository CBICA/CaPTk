...
signals:
	void RunDiffusionMeasuresCalculation(const std::string inputImageFile, const std::string inputMaskFile, const std::string inputBValFile, const std::string inputBVecFile, const bool ax, const bool fa, const bool rad, const bool tr, const std::string outputFolder);
};
