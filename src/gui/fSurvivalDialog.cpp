...
void fSurvivalPredictor::CheckForDisclaimer()
{
  ...
  if (box->exec() == QMessageBox::Ok)
  {
    ...
    std::string link =
      ...
      "wget"
#endif
      + std::string(" ftp://www.nitrc.org/home/groups/captk/downloads/SampleData_1.5.0/SurvivalPredictor_PretrainedModel.zip") +
      " -O " + captk_PretrainedFolder + "/SurvivalPredictor_PretrainedModel.zip";
