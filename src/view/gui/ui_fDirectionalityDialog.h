...
public:
  ...
  void setupUi(QDialog *fDirectionalityDialog)
  {
    ...
    roi1GroupBox->setTitle(QString::fromStdString("ROI: Timepoint 1"));
    ...
    roi2GroupBox->setTitle(QString::fromStdString("ROI: Timepoint 2"));
  ...
  void retranslateUi(QDialog *fDirectionalityDialog)
  {
    ...
    // NEW CHANGES
    fDirectionalityDialog->setWindowTitle(QApplication::translate("fDirectionalityDialog", "Directionality Estimator", 0));
    confirmButton->setText(QApplication::translate("fDirectionalityDialog", "Confirm", 0));
    cancelButton->setText(QApplication::translate("fDirectionalityDialog", "Cancel", 0));
