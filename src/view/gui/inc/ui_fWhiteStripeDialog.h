...
public:
  ...
  void setupUi(QDialog *fWhiteStripeObj)
  {
    ...
    confirmButton->setText(QApplication::translate("fWhiteStripeObj", "Confirm", 0));
    ...
    cancelButton->setText(QApplication::translate("fWhiteStripeObj", "Cancel", 0));
  ...
  {
    fWhiteStripeObj->setWindowTitle(QApplication::translate("fWhiteStripeObj", "WhiteStripe Normalization", 0));
