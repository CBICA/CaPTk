...
#ifndef UI_FHELPAPPDIALOG_H
#define UI_FHELPAPPDIALOG_H
...
public:
  ...
  void setupUi(QDialog *fHelpAppDialog)
  {
    QSize dialogSize = QSize(600,800);
    if (fHelpAppDialog->objectName().isEmpty())
      fHelpAppDialog->setObjectName(QString::fromUtf8("fHelpAppDialog"));
    fHelpAppDialog->setWindowModality(Qt::ApplicationModal);
    fHelpAppDialog->resize(dialogSize); // needs to be screenSize dependent
    QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(fHelpAppDialog);
    fHelpAppDialog->setSizePolicy(sizePolicy);
    fHelpAppDialog->setMinimumSize(QSize(0, 0));


    mainLayout = new QWidget(fHelpAppDialog);
    ...
    label4t = new QLabel(survivalTab);
    ...
    //-----------------------Shortcuts tab-----------------------------------
    confettiTab = new QWidget();
    confettiTab->setObjectName(QString::fromUtf8("confettiTab"));

    verticalLayoutS = new QVBoxLayout(confettiTab);
    verticalLayoutS->setObjectName(QString::fromUtf8("verticalLayout"));




    FrameS = new QFrame(confettiTab);
    ...
    label3stext = new QLabel(confettiTab);
    ...
    //-----------------------Drawing tab-----------------------------------
    recurrenceTab = new QWidget();
    recurrenceTab->setObjectName(QString::fromUtf8("recurrenceTab"));

    verticalLayoutD = new QVBoxLayout(recurrenceTab);
    verticalLayoutD->setObjectName(QString::fromUtf8("verticalLayout"));

    FrameD = new QFrame(recurrenceTab);
    ...
    //---------------------------------------------------------------------------------------
    tabWidget->addTab(egfrTab, QString());
    tabWidget->addTab(survivalTab, QString());
    tabWidget->addTab(recurrenceTab, QString());
    tabWidget->addTab(confettiTab, QString());
    ...
    retranslateUi(fHelpAppDialog);

    QMetaObject::connectSlotsByName(fHelpAppDialog);
  } // setupUi

  void retranslateUi(QDialog *fHelpAppDialogs)
  {
    // fHelpAppDialogs->setWindowTitle(QApplication::translate("fHelpAppDialog", "Help for Applications", 0, QApplication::UnicodeUTF8));
    // tabWidget->setTabText(tabWidget->indexOf(egfrTab), QApplication::translate("fMainWindow", "EGFRvIII Surrogate Index", 0, QApplication::UnicodeUTF8));
    // tabWidget->setTabText(tabWidget->indexOf(recurrenceTab), QApplication::translate("fMainWindow", "Glioblastoma Infiltration Index", 0, QApplication::UnicodeUTF8));
    // tabWidget->setTabText(tabWidget->indexOf(survivalTab), QApplication::translate("fMainWindow", "Survival Prediction Index", 0, QApplication::UnicodeUTF8));
    // tabWidget->setTabText(tabWidget->indexOf(confettiTab), QApplication::translate("fMainWindow", "Confetti", 0, QApplication::UnicodeUTF8));
    // NEW CHANGES
    fHelpAppDialogs->setWindowTitle(QApplication::translate("fHelpAppDialog", "Help for Applications", 0));
    tabWidget->setTabText(tabWidget->indexOf(egfrTab), QApplication::translate("fMainWindow", "EGFRvIII Surrogate Index", 0));
    tabWidget->setTabText(tabWidget->indexOf(recurrenceTab), QApplication::translate("fMainWindow", "Glioblastoma Infiltration Index", 0));
    tabWidget->setTabText(tabWidget->indexOf(survivalTab), QApplication::translate("fMainWindow", "Survival Prediction Index", 0));
    tabWidget->setTabText(tabWidget->indexOf(confettiTab), QApplication::translate("fMainWindow", "Confetti", 0));
  }
...
namespace Ui
{
  class fHelpAppDialog : public Ui_fHelpAppDialog {};
} // namespace Ui
