...
public:
  ...
  void setupUi(QMainWindow *fMainWindow)
  {
    ...
    menuApp->addSeparator();
    vectorOfSegmentationApps = populateStringListInMenu(segAppList, fMainWindow, menuApp, "Segmentation", false);
    vectorOfMiscApps = populateStringListInMenu(miscAppList, fMainWindow, menuApp, "Miscellaneous", false);
    vectorOfPreprocessingActionsAndNames = populateStringListInMenu(preProcessingAlgos, fMainWindow, menuPreprocessing, "", false);
