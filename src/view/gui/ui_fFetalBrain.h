 ...
 //   QGroupBox *outputGroupBox;
  ...
  void setupUi(QDialog *fFetalBrain)
  {
   ...
   //--------------------------input-------------------------------------------------------//
    ...
    // NEW CHANGES
    rdExistingClassification->setText(QApplication::translate("fFetalBrain", "Single Subject", 0));
    ...
    // NEW CHANGES
    rdCreateModel->setText(QApplication::translate("fFetalBrain", "Train Subject", 0));
