...
void fEGFRvIIIPredictor::CheckForDisclaimer()
{
  ...
  if (box->exec() == QMessageBox::Ok)
  {
    ...
    std::string link = 
      ...
      "wget"
#endif
      + std::string(" ftp://www.nitrc.org/home/groups/captk/downloads/SampleData_1.6.0/EGFRvIIIIndexPredictor_PretrainedModel.zip") +
      " -O " + captk_PretrainedFolder + "/EGFRvIIIIndexPredictor_PretrainedModel.zip";
