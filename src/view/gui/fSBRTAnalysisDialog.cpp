...
void fSBRTAnalysisDialog::OnURLClicked(const QString&)
{
  ...
  if (box->exec() == QMessageBox::Ok)
  {
    ...
    std::string link =
      ...
      "wget"
#endif
      + std::string(" ftp://www.nitrc.org/home/groups/captk/downloads/SampleData_1.6.0/SBRT_PretrainedModel.zip") +
      " -O " + captk_PretrainedFolder + "/SBRT_PretrainedModel.zip";
    ...
    if /*(std::system((link).c_str()) != 0)*/ (!openLink("ftp://www.nitrc.org/home/groups/captk/downloads/SampleData_1.6.0/SBRT_PretrainedModel.zip"))
    {
