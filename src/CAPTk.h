...
//{
//  IMAGE_TYPE_UNDEFINED, IMAGE_TYPE_T1, IMAGE_TYPE_T1T1CE, IMAGE_TYPE_T1CE, IMAGE_TYPE_T2, 
...
//};
//
//static const char ImageModalityString[IMAGE_TYPE_FEATURES + 1][15] = 
