...
namespace CAPTK
{
  ...
  {
      FS_TYPE_UNDEFINED = 0, FS_TYPE_ES, FS_TYPE_FFS, FS_TYPE_BACKWARDS, FS_TYPE_RANDOMFOREST,
      FS_TYPE_RELIEF_F, FS_TYPE_OPTIMIZE_ANY
  };

  enum ClassifierType
  {
    CLASS_TYPE_UNDEFINED = 0, CLASS_TYPE_SVM_LINEAR, CLASS_TYPE_SVM_RBF, CLASS_TYPE_SVM_POLYNOMIAL,
    CLASS_TYPE_SVM_SIGMOID, CLASS_TYPE_SVM_CHISQUARED, CLASS_TYPE_SVM_INTERSECTION,
    CLASS_TYPE_RANDOMFOREST, CLASS_TYPE_SGD_SVM, CLASS_TYPE_BOOSTEDTREES, CLASS_TYPE_OPTIMIZE_ANY
  };
