...
int main(int argc, char **argv)
{
  ...
  if (applicationType == CAPTK::MachineLearningApplicationSubtype::TESTING)
  {
    ...
    {
      std::cout << "The required model files PCA_PERF.csv, Mean_PERF.csv and PCCumulativeVariance.csv do not exist in the model directory:" <<  modelDirectoryName << std::endl;
      return EXIT_FAILURE;
    }
