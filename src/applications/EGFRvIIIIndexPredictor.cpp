...
int EGFRvIIIIndexPredictor::PrepareNewEGFRvIIIPredictionModel(const std::string &inputdirectory, const std::vector< std::map< ImageModalityType, std::string > > &qualifiedsubjects, const std::string &outputdirectory)
{
  ...
  for (unsigned int sid = 0; sid < qualifiedsubjects.size(); sid++)
  {
    ...
    {
      logger.WriteError("Error in calculating the features for patient ID = " + static_cast<std::string>(currentsubject[IMAGE_TYPE_PSR]) + "Error code : " + std::string(e1.what()));
      return false;
    }
  }
...
*/
  ...
  try
  {
    trainOpenCVSVM(ModelSelectedFeatures, outputdirectory + "/" + mTrainedFile, false, Survival);
  }
  catch (const std::exception& e1)
  {
...
VectorDouble EGFRvIIIIndexPredictor::EGFRvIIIPredictionOnExistingModel(const std::string &modeldirectory, const std::string &inputdirectory, const std::vector < std::map < ImageModalityType, std::string>> &qualifiedsubjects, const std::string &outputdirectory)
{
  ...
  for (unsigned int sid = 0; sid < qualifiedsubjects.size(); sid++)
  {
    ...
    try
    {
      ...
      ImageType::Pointer TemplateImagePointer21Regions = ReadNiftiImage<ImageType>(getCaPTkDataDir() + "egfrv3/template21regions.nii.gz");
      ImageType::Pointer TemplateImagePointerAllRegions = ReadNiftiImage<ImageType>(getCaPTkDataDir() + "egfrv3/templateallregions.nii.gz");
      ImageType::Pointer T1CEImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_T1CE]))));
      ImageType::Pointer RCBVImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_RCBV]))));
      ImageType::Pointer PHImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_PH]))));
      ImageType::Pointer T2FlairImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_T2FLAIR]))));
      ImageType::Pointer T1ImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_T1]))));
      ImageType::Pointer T2ImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_T2]))));
      ImageType::Pointer AXImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_AX]))));
      ImageType::Pointer RADImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_RAD]))));
      ImageType::Pointer FAImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_FA]))));
      ImageType::Pointer TRImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_TR]))));
      ImageType::Pointer PSRImagePointer = RescaleImageIntensity<ImageType>(CapImageIntensityWithPercentile<ImageType>(ReadNiftiImage<ImageType>(static_cast<std::string>(currentsubject[IMAGE_TYPE_PSR]))));
  ...
  try
  {
    ...
    if (cbica::fileExists(modeldirectory + "/EGFRvIII_SVM_Model.csv") == true)
    {
      ...
      for (size_t i = 0; i < result.Size(); i++)
      {
        ...
        if (result[i]<0)
          myfile << static_cast<std::string>(currentsubject[IMAGE_TYPE_SUDOID]) + ", Mutation not detected \n";
        else
          myfile << static_cast<std::string>(currentsubject[IMAGE_TYPE_SUDOID]) + ", Mutation detected \n";
