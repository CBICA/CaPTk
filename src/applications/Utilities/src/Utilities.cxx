...
int main(int argc, char** argv)
{
  ...
  parser.addOptionalParameter("ri", "resizeInterp", cbica::Parameter::STRING, "NEAREST:LINEAR:BSPLINE:BICUBIC:GAUSS:GAUSSLABEL", "[Resample] The interpolation type to use for resampling or resizing", "Defaults to LINEAR");
