...
int algorithmsRunner()
{
  ...
  {
    cbica::WriteDicomImage< TImageType >(targetImageFile, cbica::ReadImage< TImageType >(inputImageFile), outputImageFile);
  }
...
int main(int argc, char** argv)
{
  ...
  parser.addOptionalParameter("n2d", "nifi2dicom", cbica::Parameter::FILE, "DICOM Reference", "The header information from the DICOM reference is taken to write output", "Use '-i' to pass input NIfTI image", "Use '-o' to pass output DICOM directory");
