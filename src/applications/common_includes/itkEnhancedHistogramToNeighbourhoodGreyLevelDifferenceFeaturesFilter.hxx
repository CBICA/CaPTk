...
namespace itk {
  ...
  sumPiSi /= Nv;
      ...
      contrast = (Ngp <= 1 || Nv == 0) ? 0 : (1.0 / (Ngp * (Ngp - 1))*pipj / Nv / Nv) * (sumSi / Nv / Nv); //not sure if this should be divided by two
      busyness = (Ngp <= 1 || ipijpj == 0) ? 0 : sumPiSi / ipijpj / Nv;
      complexity = (Nv == 0) ? 0 : complexitySum / Nv / Nv;
      strength = (sumSi == 0 || Nv == 0) ? 0 : strengthSum / Nv / sumSi; //not sure if Nv should be here
