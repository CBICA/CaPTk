...
class PerfusionPCA : public ApplicationBase
{
...
public:
  ...
  template<class ImageTypeFloat4D, class ImageTypeFloat3D>
   std::vector<typename ImageTypeFloat3D::Pointer> Run(typename ImageTypeFloat4D::Pointer perfImagePointerNifti);
...
template<class ImageTypeFloat4D,class ImageTypeFloat3D>
 std::vector<typename ImageTypeFloat3D::Pointer> PerfusionPCA::Run(typename ImageTypeFloat4D::Pointer perfImagePointerNifti)
{
