/**
\file  TrainingModuleLegacyUtils.cpp

\brief The source file containing the TrainingModuleLegacyUtils class, containing functions used in CaPTk applications that are not yet updated to use newer TrainingModule code
This file is deprecated. No new code should rely on it.
...
bool TrainingModuleLegacyUtils::CheckPerformanceStatus(double ist, double second, double third, double fourth, double fifth, double sixth, double seventh, double eighth, double ninth, double tenth)
{
...
VectorDouble TrainingModuleLegacyUtils::CalculatePerformanceMeasures(VectorDouble predictedLabels, VectorDouble GivenLabels)
{
...
VectorDouble TrainingModuleLegacyUtils::CalculatePerformanceMeasures(VariableLengthVectorType predictedLabels, std::vector<double> GivenLabels)
{
  //calcualte performance measures
  double TP = 0;
  double TN = 0;
...
VectorDouble TrainingModuleLegacyUtils::InternalCrossValidation(VariableSizeMatrixType inputFeatures, std::vector<double> inputLabels, double cValue, double gValue, int kerneltype)
{
...
VectorDouble TrainingModuleLegacyUtils::InternalCrossValidationResubstitution(VariableSizeMatrixType inputFeatures, std::vector<double> inputLabels, double cValue, double gValue, int kerneltype)
{
  VariableLengthVectorType predictedLabels;
  predictedLabels.SetSize(inputLabels.size());
...
VectorDouble TrainingModuleLegacyUtils::InternalCrossValidationSplitTrainTest(VariableSizeMatrixType inputFeatures, std::vector<double> inputLabels, double cValue, double gValue, int kerneltype, int counter, std::string outputfolder)
{
  VariableLengthVectorType predictedLabels;
  predictedLabels.SetSize(inputLabels.size());
...
VectorDouble TrainingModuleLegacyUtils::CrossValidation(const VariableSizeMatrixType inputFeatures, const VariableLengthVectorType inputLabels, const TrainingModuleParameters& params)
{
...
VectorDouble TrainingModuleLegacyUtils::EffectSizeFeatureSelection(const VariableSizeMatrixType training_features, std::vector<double> target)
{
  //make set 1and set2
  int NoOfSamplesC1 = 0;
  int NoOfSamplesC2 = 0;
...
//
//VectorDouble TrainingModuleLegacyUtils::CorrelationBasedFeatureSelection(const VariableSizeMatrixType training_features, std::vector<double> target)
//{
//  //make set 1and set2
//  int NoOfSamplesC1 = 0;
//  int NoOfSamplesC2 = 0;
...
//----------------------------------------------------------------------------------------------
VectorDouble TrainingModuleLegacyUtils::CombineEstimates(const VariableLengthVectorType &estimates1, const VariableLengthVectorType &estimates2)
{
...
VectorDouble TrainingModuleLegacyUtils::testOpenCVSVM(const VariableSizeMatrixType &testingData, const std::string &inputModelName)
{
...
bool TrainingModuleLegacyUtils::Run(const TrainingModuleParameters& params)
{
  ...
  TrainingModuleLegacyUtils mTrainingSimulator;
...
VectorDouble TrainingModuleLegacyUtils::SplitTrainTest(const VariableSizeMatrixType inputFeatures, const VariableLengthVectorType inputLabels,
...
VectorDouble TrainingModuleLegacyUtils::TrainData(const VariableSizeMatrixType inputFeatures, const VariableLengthVectorType inputLabels,
...
bool TrainingModuleLegacyUtils::TrainData2(const VariableSizeMatrixType inputFeatures, 
...
VectorDouble TrainingModuleLegacyUtils::TestData(const VariableSizeMatrixType inputFeatures,  const TrainingModuleParameters& params)
{
...
//----------------------------------------------------------------------------------------------------------
std::vector<int> TrainingModuleLegacyUtils::UpdateUnselectedFeatures(std::vector<int> SelectedFeatures,int featuresize)
{
...
//-----------------------------------------------------------------------------------------------------------
std::vector<int> TrainingModuleLegacyUtils::SVMFFSBasedFeatureSelection(const VariableSizeMatrixType inputdata, const VectorDouble labels, const TrainingModuleParameters& params, VectorDouble &crossvalidatedaccuracies)
{
  auto optimizationType = params.optimizationType;
...
std::vector<int> TrainingModuleLegacyUtils::EffectSizeBasedFeatureSelection(const VariableSizeMatrixType inputdata, const VectorDouble labels,const TrainingModuleParameters& params,VectorDouble & crossvalidatedaccuracies)
{
  auto optimizationtype = params.optimizationType;
  auto classifiertype = params.classifierType;
  auto cvtype = params.crossValidationType;
