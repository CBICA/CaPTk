...
int main(int argc, char** argv)
{
  ...
  parser.addOptionalParameter("o", "outputDir", cbica::Parameter::DIRECTORY, "none", "Output directory where all data is written", "Not required if individual files are passed");
