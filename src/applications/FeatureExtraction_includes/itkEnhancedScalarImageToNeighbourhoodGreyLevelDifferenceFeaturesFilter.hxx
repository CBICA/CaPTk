...
namespace itk
{
  namespace Statistics
  {
      ...
      ::EnhancedScalarImageToNeighbourhoodGreyLevelDifferenceFeaturesFilter()
    {
      ...
      /*
      2018-06-01 Sung
      Note that these five are the complete set of five features explained in the IBSI standard
      */


      //2018-06-01 Sung
      std::cout << "itkEnhancedScalarImageToNeighbourhoodGreyLevelDifferenceFeaturesFilter.hxx" << std::endl;
      //2018-06-01 Sung

      this->SetRequestedFeatures(requestedFeatures);
      /*
      2018-06-01 Sung
      Note that neighborhood defaults to HALF of all possible directions with radius of 1
      */
      ...
      //2018-06-01 Sung
      std::cout << "\n\nhood.getRadius = " << hood.GetRadius() << std::endl;
      //2018-06-01 Sung

      /*
      2018-06-01 Sung
      setting radius of neighborhood iterator to 1
      will result in 9 (self voxel + 8 surrounding voxels) for 2D
      will result in 27 (self voxel + 26 surrounding voxels in 3D) for 3D
      */
      ...
      for (unsigned int d = 0; d < centerIndex; d++)
      {
        ...
        // 2018-06-01 Sung
        //offset.
        //  std::cout << "adding offset (" << d << ") to neighborhood | centerIndex(" << centerIndex << ")" << std::endl;
        //std::cout << "offset(" << d << ") has directionality " << offset << std::endl;
        // 2018-06-01 Sung
      }
      this->SetOffsets(offsets);

      std::cout << "\n\nFinish setting offsets for NGTDM" << std::endl;

      this->m_FastCalculations = false;

      std::cout << "\n\nFinished setting fastCalculations off" << std::endl;

    }

    /*
    2018-06-01 Sung
    Choose offsets 0 to 4 for 2D, 0 to 13 for 3D
    */
