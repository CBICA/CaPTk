...
public:
  ...
  template < class TImageType = ImageTypeFloat>
  ...
  void calculateLBP(typename TImageType::Pointer  inputImage, typename TImageType::Pointer  mask,
    typename TImageType::Pointer  roi, int radius, int neighbours, std::string modality, std::string label, FeatureBaseType1* featurevec);
private:
