...
::GenerateData()
{
  ...
  typedef itk::Image<LabelPixelType, ImageType::ImageDimension > LabelImageType;
  ...
  typedef itk::Image< unsigned int, ImageType::ImageDimension >     OutputImageType;
  ...
  if (ImageType::ImageDimension == 2)
  {
    ...
    for (int x = 0; x < xx; x++)
    {
      for (int y = 0; y < yy; y++)
      {
        typename FloatImageType::IndexType indexF;
        indexF[0] = x;
        indexF[1] = y;

        typename OutputImageType::IndexType indexO;
        indexO[0] = x;
        indexO[1] = y;
  ...
  */
  ...
  //2018-06-08 Replacing mitk::eps with std::numeric_limits::epsilon
  // PixelType distanceThreshold = 1 - mitk::eps;
  PixelType distanceThreshold = 1 - std::numeric_limits< typename TImageType::PixelType >::epsilon();
