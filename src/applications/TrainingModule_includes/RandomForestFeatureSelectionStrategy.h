/** 
\file RandomForestFeatureSelectionStrategy.h

\brief The header file containing the RandomForestFeatureSelectionStrategy class. 
This defines an extension of the IFeatureSelectionStrategy interface to cover OpenCV Random Forest-based feature selection.
...
class RandomForestFeatureSelectionStrategy : public IFeatureSelectionStrategy
{
