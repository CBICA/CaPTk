/** 
\file OpenCVSVMClassifierStrategy.h

\brief The header file containing the OpenCVSVMClassifierStrategy class. 
This class defines an implementation of the IClassifierStrategy interface to cover the SVM from OpenCV.
...
class OpenCVSVMClassifierStrategy : public IClassifierStrategy
{
