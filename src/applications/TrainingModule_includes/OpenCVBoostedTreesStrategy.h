/** 
\file OpenCVBoostedTreesStrategy.h

\brief The header file containing the OpenCVBoostedTreesStrategy class. 
This class defines an implementation of the IClassifierStrategy interface to cover the "Boost" (boosted decision tree predictor) from OpenCV.
...
class OpenCVBoostedTreesStrategy : public IClassifierStrategy
{
...
protected:
	...
	cv::Ptr<cv::ml::Boost> _BoostedTrees;
