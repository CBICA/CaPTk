/** 
\file OpenCVRandomForestStrategy.h

\brief The header file containing the OpenCVRandomForestStrategy class. 
This class defines an implementation of the IClassifierStrategy interface to cover the RTrees (random forest predictor) from OpenCV.
...
class OpenCVRandomForestStrategy : public IClassifierStrategy
{
