...
template<class ImageType>
typename ImageType::Pointer MolecularSubtypePredictor::GetDistanceMapWithLabel(const typename ImageType::Pointer &labelImagePointer, const int &label1, const int &label2)
{
